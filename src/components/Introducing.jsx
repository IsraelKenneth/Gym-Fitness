...
const Introducing = () => {
  return (
    <section id='introducing' className={`flex md:flex-row flex-col sm:py-10 py-6 `} >
...
Introducing Angela Lopez </h1>
            <h4 className='uppercase font-poppins font-semibold ss:leading-[40.8px] leading-[48px]'>Wooded ladies she basket season age her uneasy saw</h4>
</div>
...
<p className={`flex mt-4  ${styles.flexStart}`}>Folly words widow one downs few age every seven. If miss part by fact he park just shew. Discovered had get considered projection who favourable. Necessary up knowledge it tolerably. Unwilling departure education is be dashwoods or an.</p>
      ...
      <div className={`flex flex-1 flex-col justify-end items-center w-[50%]   text-black `}>
          <div className={`flex flex-row justify-end items-center`} >
            <img className='mr-10 w-[200px]' src={certification0} alt="Fitness training" />
            <img className='mr-10 w-[200px]' src={certification1} alt="Fitness training" />
      </div>
          <div className={`flex flex-row justify-end items-center mt-5`}>
            <img className='mr-10 w-[200px]' src={certification2} alt="Fitness training" />
            <img className='mr-10 w-[200px]' src={certification3} alt="Fitness training" />
          </div>
